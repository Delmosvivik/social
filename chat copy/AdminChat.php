    ...
    <div id="chat-container">
        ...
        <div id="chat-messages">
            ...
            <?php if (isset($_SESSION['user_id'])) {
                // isset - определена ли переменная, если переменная  существует от true иначе fales
                echo '<script>selectedUserId = ' . $_SESSION['user_id'] . ';</script>';
                include 'getMessages.php';
            } ?>
        </div>
    </div>
    <div id="message-input"> <input type="text" id="message" contenteditable="true" placeholder="Введите ваше сообщение...">
